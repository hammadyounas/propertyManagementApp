    ...
    <Modal
      ...
      footerContent={
        <div className="flex justify-end space-x-3">
          ...
          />
          <Button
            text={loading ? "Saving & Sending..." : "Send & Save"}
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-gray-700 dark:text-gray-300">
              ...
              <p className="mt-3 text-xs italic">
                When you click "Send & Save", the system will:
              </p>
              <ol className="mt-2 space-y-1 text-xs list-decimal list-inside">
                <li>Upload PDF to Cloudinary</li>
                <li>Send email with PDF link</li>
                <li>Save document to database</li>
              </ol>
            </div>
          </div>
        </div>
