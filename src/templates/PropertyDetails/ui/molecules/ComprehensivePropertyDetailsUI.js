...
const ComprehensivePropertyDetailsUI = ({ propertyDetails }) => {
  ...
  return (
    <div className="space-y-8">
      {/* Property Header */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100 mt-4">
          <div className="flex justify-between items-center max-sm:flex-col w-full">
            <div>
            <h1 className="text-2xl">{propertyDetails.title}</h1>
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-900">{propertyDetails.no_of_units || "N/A"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-900">{propertyDetails.land_area || "N/A"}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="font-semibold text-gray-900">{propertyDetails.year_built || "N/A"}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-600">Building Stories</label>
              <p className="text-gray-900">{propertyDetails.building_stories || "N/A"}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Unit Size</label>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-600">Ownership Status</label>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-600">Street Number</label>
              <p className="text-gray-900">{propertyDetails.street_number || "N/A"}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Street Name</label>
              <p className="text-gray-900">{propertyDetails.street_name || "N/A"}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Cadastral Number</label>
              <p className="text-gray-900">{propertyDetails.cadastral_number || "N/A"}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <label className="text-sm font-medium text-gray-600">Number of Garages</label>
            <p className="text-gray-900 text-lg font-semibold">{propertyDetails.no_of_garages || "N/A"}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Parking Places</label>
            <p className="text-gray-900 text-lg font-semibold">{propertyDetails.no_of_parking_places || "N/A"}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Parking Surface</label>
            <p className="text-gray-900">{propertyDetails.parking_surface || "N/A"}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-600">Heating Responsibility</label>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-600">Hot Water Responsibility</label>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-600">Plumbing</label>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="text-sm font-medium text-gray-600">Appliances Responsibility</label>
            <p className="text-gray-900">{propertyDetails.responsibility_of_appliances || "N/A"}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Washer/Dryer Installation</label>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-600">Flooring Condition</label>
              <p className={`font-medium ${getConditionColor(propertyDetails.condition_of_flooring)}`}>
                {propertyDetails.condition_of_flooring || "N/A"}
              </p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Balcony Condition</label>
            ...
            <div>
              <label className="text-sm font-medium text-gray-600">Door Condition</label>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-gray-600">Window Condition</label>
              <p className={`font-medium ${getConditionColor(propertyDetails.condition_of_windows)}`}>
                {propertyDetails.condition_of_windows || "N/A"}
              </p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Siding</label>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <label className="text-sm font-medium text-gray-600">Intercom System</label>
            <p className="text-gray-900">{propertyDetails.intercom_system || "N/A"}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Fire Alarm System</label>
            <p className="text-gray-900">{propertyDetails.fire_alarm_system || "N/A"}</p>
          </div>
          <div>
            <label className="text-sm font-medium text-gray-600">Janitor Agreement</label>
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {propertyDetails.revenue.residential && (
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-green-800 mb-2 text-lg">Residential</h5>
                ...
                {propertyDetails.revenue.commercial && (
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-blue-800 mb-2 text-lg">Commercial</h5>
                ...
                {propertyDetails.revenue.parking && (
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-purple-800 mb-2 text-lg">Parking</h5>
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-gray-800 mb-2 text-lg">Total Gross Income</h5>
                  <p className="text-lg font-semibold text-gray-900">{formatCurrency(propertyDetails.revenue.total_gross_income)}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-gray-800 mb-2 text-lg">Gross Income Per Unit</h5>
                  <p className="text-lg font-semibold text-gray-900">{formatCurrency(propertyDetails.revenue.gross_income_per_unit)}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {propertyDetails.financial_analysis && (
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-blue-800 mb-2 text-lg">Net Income</h5>
                  <p className="text-lg font-semibold text-blue-900">{formatCurrency(propertyDetails.financial_analysis.net_income)}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-green-800 mb-2 text-lg">Cap Rate</h5>
                  <p className="text-lg font-semibold text-green-900">{propertyDetails.financial_analysis.cap_rate ? `${propertyDetails.financial_analysis.cap_rate}%` : "N/A"}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-purple-800 mb-2 text-lg">Price Per Unit</h5>
                  <p className="text-lg font-semibold text-purple-900">{formatCurrency(propertyDetails.financial_analysis.price_per_unit)}</p>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-900 text-lg font-semibold">{propertyDetails.owner_name || "N/A"}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600 flex items-center">
